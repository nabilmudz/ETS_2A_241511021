...
Route::prefix('/public')
    ...
    Route::get('/anggota-dpr', [AnggotaController::class, 'index'])->name('user.anggota.index');
    Route::get('/gaji-dpr', [PenggajianController::class, 'index'])->name('user.penggajian.index');
});
